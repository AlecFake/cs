...
> 对于开发工程师来说，数据库知识是必备的基础知识，因此对数据库的深入学习是必须的。无论是在工作中还是在面试中，数据库知识走占据了很重要的地位。而事务在数据库中，是一个极其重要的概念，因此搞清楚事务的相关的知识很有必要。本文将通过实例分析事务的四大特性，并且从事务的隔离性扩展开来，介绍事务的隔离级别及其具体实现，并引出长事务的风险。
...
![](https://github.com/guokaide/cs/blob/master/pictures/rollback.png)
